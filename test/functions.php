...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'Sliders', 'Post Type General Name', 'test' ),
        'singular_name'       => _x( 'Slider', 'Post Type Singular Name', 'test' ),
        'menu_name'           => __( 'Sliders', 'test' ),
        'parent_item_colon'   => __( 'Parent Slider', 'test' ),
        'all_items'           => __( 'All Sliders', 'test' ),
        'view_item'           => __( 'View Slider', 'test' ),
        'add_new_item'        => __( 'Add New Slider', 'test' ),
        'add_new'             => __( 'Add New', 'test' ),
        'edit_item'           => __( 'Edit Slider', 'test' ),
        'update_item'         => __( 'Update Slider', 'test' ),
        'search_items'        => __( 'Search Slider', 'test' ),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        'label'               => __( 'sliders', 'test' ),
        'description'         => __( 'Sliders and reviews', 'test' ),
        'labels'              => $labels,
